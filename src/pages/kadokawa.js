...
export const Head = ({ data}) => {
  return (
    <Seo
      ...
      description={`KADOKAWAの本の一覧、KADOKAWAの本を一覧で表示します。`}
    />
  )
}

export default Kadokawa
...
query MyQuery {
  allJson(filter: {Publisher: {regex: "/KADOKAWA/"}}, sort: {ReleaseDate: ASC}) {
    nodes {
      Asin
      Booktype
      Category
