...
export const Head = ({ data}) => {
  return (
    <Seo
      ...
      description={`講談社の本の一覧、講談社の本を一覧で表示します。`}
    />
  )
}

export default Kodansha
...
query MyQuery {
  allJson(filter: {Publisher: {regex: "/講談社/"}}, sort: {ReleaseDate: ASC}) {
    nodes {
      Asin
      Booktype
      Category
