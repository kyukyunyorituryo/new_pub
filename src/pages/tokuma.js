...
export const Head = ({ data}) => {
  return (
    <Seo
      ...
      description={`徳間書店の本の一覧、徳間書店の本を一覧で表示します。`}
    />
  )
}

export default Tokumashoten
...
query MyQuery {
  allJson(filter: {Publisher: {regex: "/徳間書店/"}}, sort: {ReleaseDate: ASC}) {
    nodes {
      Asin
      Booktype
      Category
