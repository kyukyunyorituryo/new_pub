...
export const Head = ({ data}) => {
  return (
    <Seo
      ...
      description={`小学館の本の一覧、小学館の本を一覧で表示します。`}
    />
  )
}

export default Shougakukan
...
query MyQuery {
  allJson(filter: {Publisher: {regex: "/小学館/"}}, sort: {ReleaseDate: ASC}) {
    nodes {
      Asin
      Booktype
      Category
