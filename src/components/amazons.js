     ...
     <div key={e.Asin}>
        <a className="amazon-card-container" target="_blank" rel="noopener noreferrer" href={e.URL}>
          <div className="amazon-card-body">
            ...
            <div className="amazon-card-domain">価格：{e?.Price || `なし`}円、ポイント：{e.Points}、{e.Contributor}、出版社：{e.Publisher}、カテゴリー：{e.Category}、発売日：{e.ReleaseDate.substr( 0, 4 )+"/"+e.ReleaseDate.substr( 4, 2 )+"/"+e.ReleaseDate.substr( 6, 2 )}</div>
          </div>
